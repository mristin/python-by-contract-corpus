...
class RuleSequence(Rule):
    ...
    def match(self, text: str) -> Optional[str]:
        remaining = text
        for rule in self.rules:
            remaining = rule.match(remaining)
...
def interpret_rule_0(rule_trees: Mapping[int, Node]) -> Rule:
    ...
    # fmt: off
    # ERROR: icontract.errors.ViolationError:
    ...
    #     )):
    # interpreted_rules was {4: <aocdbc.day_19_monster_messages.RuleLiteral object at 0x00000214649E2C70>}
    # isinstance(rule_tree, NodeReference) was True
    # result was <aocdbc.day_19_monster_messages.RuleLiteral object at 0x00000214649E2C70>
    # rule_tree was <aocdbc.day_19_monster_messages.NodeReference object at 0x0000021464A63040>
    # rule_tree.identifier was 4
    #
    # (mristin, 2021-04-08): This was a tough one. I misplaced the brackets, so ``not``
