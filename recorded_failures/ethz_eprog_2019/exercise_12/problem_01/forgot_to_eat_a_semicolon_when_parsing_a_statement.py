...
def _parse_stmt(tokens: TokensWoWhitespace, cursor: int) -> Tuple[Statement, int]:
    ...
    # ERROR:
    # SyntaxError:
    # Expected at least three tokens for the assignment at cursor 8,
    # but len(tokens) was 9:
    # [Token('A = sin((A));\n', 12, 13, <TokenKind.SEMICOLON: 9>)]
    #
    # The semi-colon should have been matched here.
