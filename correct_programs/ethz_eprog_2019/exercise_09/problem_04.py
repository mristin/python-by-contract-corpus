...
Additionally, we exclude the parts a) and b) from the original problem as not really
interesting for the contracts as they are focused on teaching concepts of inheritance.
We therefore focus on part c) of the problem, which is much more complex and
algorithmically more involving.)
