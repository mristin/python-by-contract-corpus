...
# I got the post-condition on the length of tokens and the result wrong in the edge case
# when all the tokens are unique. I should have written a post-condition like this
# instead:
