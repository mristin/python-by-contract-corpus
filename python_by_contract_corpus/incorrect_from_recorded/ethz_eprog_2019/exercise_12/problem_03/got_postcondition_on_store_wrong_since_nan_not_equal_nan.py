...
# I got the following post-condition wrong since I only checked for equality, but the
# equality on NaN's is always False and needs to be checked separately.
# I should have written something like this post-condition instead:
# @ensure(
#     lambda stack, OLD:
#     all(
...
@snapshot(lambda stack: stack[:])
# ERROR (mristin, 2021-06-19):
# Please see the error above. I should have written something like this post-condition
# instead:
# @ensure(
#     lambda stack, OLD:
#     all(
