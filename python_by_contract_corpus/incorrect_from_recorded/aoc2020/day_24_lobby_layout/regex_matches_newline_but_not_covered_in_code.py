...
# DIRECTIONS_RE will match a string ending in a new line.
# However, VALUE_TO_DIRECTION will fail on the new line!
DIRECTIONS_RE = re.compile("^(se|sw|nw|ne|w|e)+$")  #: Express a list of directions
